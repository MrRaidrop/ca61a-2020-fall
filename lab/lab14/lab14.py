...
def prune_min(t):
    ...
    if t.is_leaf():
        ...
        branch1,branch2=t.branches[0],t.branches[1]
...
class CheckingAccount(Account):
    ...
    def deposit_check(self, check):
        if check.name!=self.holder or check.deposited==True:
            print('The police have been notified.')
            return
        else:
            check.deposited=True
            self.deposit(check.amount-CheckingAccount.withdraw_fee)
            return check.amount
