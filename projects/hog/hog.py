...
def swine_align(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4a
    x=max(player_score,opponent_score)
    if player_score*opponent_score==0:
        return False
    while x>0:
        if player_score%x==0 and opponent_score%x==0:
            return x>=10
        else :
            x-=1
    # END PROBLEM 4a
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    """
    who = 0  # Who is afout to take a turn, 0 (first) or 1 (second)
    # BEGIN PROBLEM 5
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        if who==0:
            s0,r0=last_score,running_high
            if (score0-s0)>r0:
                r0=score0-s0
                print((r0),'point(s)! The most yet for Player 0')
                return announce_highest(0,score0,r0)
            else:
                return announce_highest(0,score0,running_high)

        elif who==1:
            s1,r1=last_score,running_high
            if (score1-s1)>r1:
                r1=score1-s1
                print((r1),'point(s)! The most yet for Player 1')
                return announce_highest(1,score1,r1)
            else:
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    score_new=free_bacon(opponent_score)+score
    if extra_turn(score_new,opponent_score):
        return 0
    elif free_bacon(opponent_score)>=8.6:
        return 0
    else:
        return num_rolls
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if extra_turn(score_new,opponent_score):
        ...
        return 0
    elif opponent_score-score==3:
        return 10
    elif opponent_score-score>33:
        return 10
    else:
        return 6
    # END PROBLEM 12
